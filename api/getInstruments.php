...
$tools = [['Список користувачів', 'Додати користувача', 'Видалити користувача', 'Редагувати користувача', 'Список магазинів', 'Додати магазин', 'Видалити магазин', 'Редагувати магазин'], ['Переглянути замовлення', 'Сума замовлень', 'Додати категорію', 'Видалити категорію', 'Редагувати позицію', 'Додати позицію', 'Видалити позицію', 'Редагувати позицію'], ['Історія замовлень', 'Каталог товарів', 'Поточне замовлення']];
